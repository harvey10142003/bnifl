...
export const news: News[] = [
  ...
  },
  {
    ...
    excerpt:
      '富聯白金分會將於 5/22 舉辦半年度 BOD 擴大商機日，邀請 200+ 高雄企業主一同見證引薦平台的商業實力。',
    content:
      '時間：2026 年 5 月 22 日（週四）06:30 - 09:30\n地點：高雄福華大飯店 5F\n當日活動包含：分會 60 秒輪播、會員代表簡報、高峰交流時間、來賓自我介紹、抽獎活動。歡迎各產業老闆、業務主管、高階經理人報名參加。',
    category: '活動公告',
