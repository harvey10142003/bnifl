    ...
    <>
      ...
      <Section>
        <div className="container-bnifl max-w-3xl">
          <p className="text-xl leading-relaxed text-ink-700 font-serif mb-10 text-pretty border-l-2 border-platinum-500 pl-6">
            {item.excerpt}
          </p>
      ...
      <Section className="bg-pearl-200">
        <div className="container-bnifl">
          <div className="flex items-end justify-between mb-12 gap-6">
            <h2 className="font-serif text-display-sm">更多消息</h2>
